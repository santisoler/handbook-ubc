...
encouraged nor prohibited. In case these tools are used, one must ensure
that:
...
* You have a strong understanding of the suggested output or solution. For
  ...
  it doesn't.
* The output produced by a generative AI tool is not a copy of an original work
  that might lead to violation of its license.
  ...
  If it is a copy, make sure you have permission to reuse it, and you comply
  with its license (e.g provide attribution if required, etc.).

If any of the previous requirements isn't met, the use of the generated output
should be **seriously considered**. Consequences of its usage can go from
writing scientifically incorrect statements, mislearning fundamental topics, up
to license violations and plagiarism.
